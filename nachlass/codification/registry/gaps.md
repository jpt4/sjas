...
| G3 | ASL-2005 floating-point companion TR (JSL 2005 ref. [71]) | missing witness | open | Estate/collected-materials search; published successors witnessed (Willard2005-TAB, Willard2006b) |
...
| G8 | Complete resolution-specific stability/compactification proof unprinted in accessible corpus | stated-not-proved | open | 2026-07-28 apparatus-audit finding; re-evaluate after G1 (Willard2021) is acquired |
