...
| Gaps | [`registry/gaps.md`](registry/gaps.md) | live; G1–G29 (G9, G23, G25, G28, G29 closed) |
| Concordance | [`concordance/`](concordance/) | drift ledger live (D1–D44); [composition obligations](concordance/composition-obligations.md) live (O1–O58); axes and matrix built at C13 |
