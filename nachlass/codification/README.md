...
| Gaps | [`registry/gaps.md`](registry/gaps.md) | live; G1–G31 (G9, G21, G23, G25, G28, G29 closed) |
| Concordance | [`concordance/`](concordance/) | drift ledger live (D1–D46); [composition obligations](concordance/composition-obligations.md) live (O1–O66); axes and matrix built at C13 |
